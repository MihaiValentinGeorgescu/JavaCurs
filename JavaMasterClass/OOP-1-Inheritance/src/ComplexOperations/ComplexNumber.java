...
public class ComplexNumber {
    ...
    public void add(ComplexNumber parameter){
        this.imaginary = this.imaginary + parameter.imaginary;
        this.real = this.real + parameter.real;
    }
...
Write a class with the name ComplexNumber. The class needs two fields (instance variables) with name
real and imaginary of type double. It represents the Complex Number.

The class needs to have one constructor. The constructor has parameters real and imaginary of type
...
parameters from fields, in other words, it needs to do a complex number subtract operation as described
above.
